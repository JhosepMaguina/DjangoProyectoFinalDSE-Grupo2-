from django.shortcuts import render, redirect #PROCESO DE COMPRA: Anadir/Elminar productos del Carrito.
...
from django.views.generic import View, UpdateView, DeleteView #PROCESO DE COMPRA: Anadir/Elminar productos del Carrito.
...
class RegistrationView(FormView):
    ...
    def form_valid(self, form):
        ...
        if is_cliente:
            ...
            cliente.save()
            Pedido.objects.get_or_create(cliente=cliente, estado='EP')
...
class PedidoDestroyView(DeleteView):
    model = Pedido
    success_url = reverse_lazy('home')
